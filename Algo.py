    ...
    def printMap(self):
        ...
        for row in range(0, self.num_rows):
            for col in range(0, self.num_cols):
                if self.map_array[row][col] == 2:
                    print(Fore.BLUE + str(self.map_array[row][col]), end = " ")
                elif self.map_array[row][col] == 3:
                    print(Fore.RED + str(self.map_array[row][col]), end = " ")
                else:
                    print(Style.RESET_ALL + str(self.map_array[row][col]), end = " ")
            print()
